...
public class ProviderApiController {
    ...
    // PV-004: Cập nhật trạng thái đơn (Provider: ghi nhận HĐ, bắt đầu, hoàn thành, hủy, từ chối)
    ...
    public ResponseEntity<?> updateOrderStatus(@PathVariable Integer providerId,
        ...
        try {
            // Giao cho service kiểm tra flow trạng thái, permission, v.v.
            ...
            // Đồng bộ sang bảng service_requests (để customer/requests hiển thị đúng)
            ...
            // Sai luồng trạng thái (ví dụ: completed -> in_progress, hủy sau khi đã thanh toán nếu service chặn)
    ...
    // === Nút "Xác nhận đã thanh toán" cho Provider: ĐÃ BỎ, vì chức năng này chuyển sang ADMIN ===
    // (Giữ comment để sau đọc code còn hiểu context, nhưng không expose endpoint nữa)
